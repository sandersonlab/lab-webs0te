...
const applyPage = () => {
  ...
  return (
    ...
    <div>
        ...
        <h1 className="text-2xl text-gray-800 uppercase mb-4">Join us </h1>
        <p>
        ...
        <p>
            If you are interested in joining the lab, you can send informal enquiries to <a href="mailto:theo@theo.io">Theo Sanderson</a>, or you can fill in the form below.
        </p>
         </div>
    <div className="bg-white bg-opacity-90 rounded-lg shadow-lg p-8 mt-8">
    <div className="container mx-auto p-4">
      <h1 className="text-2xl text-gray-800 uppercase mb-4">
      Express informal interest in joining the laboratory</h1>
